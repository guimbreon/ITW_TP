...
function maiorDeDoisNumeros(num1, num2) {
  if (num1 > num2){
    ...
    return num2; //aqui se for igual  ou maior retorna o 2º nro
  }
}
...
function processaDoisNumeros(){
  ...
  let maior = maiorDeDoisNumeros(num1, num2);
  let menor = num1 !== maior ? num1 : num2;
  /*Se o numero1 for diferente do maior, então é o menor
  Se for igual, é o maior logo o menor é o num2 */
  return "Os números digitados foram " + num1 + " e " + num2 + ", o maior é " + maior + " e o menor é " + menor;
