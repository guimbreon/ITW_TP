...
/** Identificador do botão para remover o histórico das encomendas. */
const BOTAO_APAGAR_HIST = "btnApagarHistorico";
...
// Exercício: Colocar aqui o código em falta
const NASCIMENTO_CLIENTE = 'DataDeNascimento'
/* ------------------------------------------------------------------------- */
 ...
 * @param {string} morada - Nome do cliente.
 * @param {string} nascimento - Nome do cliente.
 */
function Cliente(nome, morada, nascimento) {
 ...
 */
function Encomenda(piza, cliente, quant) {
...
function defineEventHandlersParaElementosHTML() {
  ...
  document.getElementById(BOTAO_FAZER_ENCOMENDA).
    ...
    document.getElementById(BOTAO_APAGAR_HIST).
...
function trataFazerEncomenda() {
  ...
  if (encomendaValida) {
    ...
    encomenda = new Encomenda(obtemDadosPiza(), obtemDadosCliente(), obtemQuantidadePizas());
...
function obtemDadosCliente() {
  ...
  // Exercício: Rever a instrução seguinte.
  return new Cliente(formulario.elements[NOME_CLIENTE].value, formulario.elements[MORADA_CLIENTE].value, formulario.elements[NASCIMENTO_CLIENTE].value);
}
...
function obtemQuantidadePizas() {
    return formulario.elements[QUANTIDADE_PIZAS].value
  // Exercício: Colocar aqui o código em falta.
}
...
function mostraHistoricoEncomendas() {
  ...
  for (let encomenda of encomendas) {
    ...
    linhaTabela.innerHTML = "<td>" + numeroEncomenda + "</td>" +
                            ...
                            "<td>" + encomenda.cliente.nascimento + "</td>" +
